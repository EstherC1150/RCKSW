...
import { UploadProgress } from "@/app/utils/api";
...
interface ComponentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (formData: TComponentFormData, onProgress?: (progress: UploadProgress) => void) => Promise<boolean | void> | void;
  categories: Category[];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        await onSubmit(finalFormData, (progress) => {
                        ...
                        {!autoGeneratedThumbnail && (
                          <div className="absolute bottom-2 right-2 z-20">
                            <button
                              ...
                              className="bg-cyan-600 hover:bg-cyan-500 text-white text-[11px] font-medium px-2.5 py-1.5 rounded-lg shadow-lg border border-cyan-400/50 flex items-center gap-1 transition-all active:scale-95 cursor-pointer"
                              title="현재 각도로 썸네일 캡처"
                            >
                              썸네일 캡처
                            </button>
