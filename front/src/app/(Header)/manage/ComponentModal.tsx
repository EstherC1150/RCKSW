    ...
    <div className="fixed inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50">
      ...
      {isSubmitting && (
        <div className="fixed inset-0 bg-black/85 backdrop-blur-md flex flex-col items-center justify-center z-[100] p-6 text-center">
          ...
          <h4 className="text-white font-bold text-lg mb-2">컴포넌트 정보를 서버로 업로드하는 중입니다...</h4>
                          ...
                          <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center z-10 p-2">
                             ...
                             <div className="absolute bottom-2 right-2 z-20">
                               <button
                                 ...
                                 className="bg-rose-600 hover:bg-rose-500 text-white text-[11px] font-medium px-2.5 py-1.5 rounded-lg shadow-lg border border-rose-400/50 flex items-center gap-1 transition-all active:scale-95 cursor-pointer"
